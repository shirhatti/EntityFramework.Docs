...
See the [.NET Core website](https://www.microsoft.com/net/core) for instructions on installing the SDK on your operating system.
   ...
   * Create a new folder `ConsoleApp/` for your project. All files for the project should be in this folder.
        ...
        <!-- literal_block {"ids": [], "xml:space": "preserve", "classes": [], "dupnames": [], "linenos": false, "backrefs": [], "highlight_args": {}, "names": [], "language": "bash"} -->
   ...
   * To add EF to your project, modify `project.json` so it matches the following sample.
        ...
        <!-- literal_block {"ids": [], "source": "/Users/shirhatti/src/EntityFramework.Docs/docs/platforms/netcore/Platforms/NetCore/ConsoleApp.SQLite/project.json", "classes": [], "dupnames": [], "linenos": true, "backrefs": [], "highlight_args": {"hl_lines": [8, 9, 10, 11, 12, 25, 26, 27], "linenostart": 1}, "language": "json", "names": [], "xml:space": "preserve"} -->
...
With this new project, you are ready to begin using Entity Framework. The next steps will add code to configure and access a SQLite database file.
   ...
   * Create a new file called `Model.cs`
        ...
        All classes in the following steps will be added to this file.
           ...
           <!-- literal_block {"ids": [], "source": "/Users/shirhatti/src/EntityFramework.Docs/docs/platforms/netcore/Platforms/NetCore/ConsoleApp.SQLite/Model.cs", "classes": [], "dupnames": [], "linenos": true, "backrefs": [], "highlight_args": {"linenostart": 1}, "language": "c#", "names": [], "xml:space": "preserve"} -->
   ...
   * Add a new class to represent the SQLite database.
        ...
        We will call this `BloggingContext`. The call to `UseSqlite()` configures EF to point to a *.db file.
           ...
           <!-- literal_block {"ids": [], "source": "/Users/shirhatti/src/EntityFramework.Docs/docs/platforms/netcore/Platforms/NetCore/ConsoleApp.SQLite/Model.cs", "classes": [], "dupnames": [], "linenos": true, "backrefs": [], "highlight_args": {"hl_lines": [1, 8], "linenostart": 1}, "language": "c#", "names": [], "xml:space": "preserve"} -->
...
<!-- literal_block {"ids": [], "source": "/Users/shirhatti/src/EntityFramework.Docs/docs/platforms/netcore/Platforms/NetCore/ConsoleApp.SQLite/Program.cs", "classes": [], "dupnames": [], "linenos": true, "backrefs": [], "highlight_args": {"linenostart": 1}, "language": "c#", "names": [], "xml:space": "preserve"} -->
